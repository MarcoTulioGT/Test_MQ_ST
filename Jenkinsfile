pipeline {
    ...
    stages {
            ...
            steps {
				   ...
				   props.pipelineConfig.configuration[12].value = '[{"value":"amqp://172.22.52.227","key":"pMQHost"},{"value":"V1SERHED","key":"pMQQueue"},{"value":"guest","key":"pMQUser"},{"value":"guest","key":"pMQPassword"}]'
